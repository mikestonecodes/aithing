	...
	return strings.concatenate(
		{
			...
			"Your turn is over when you write your last message, and a command still\n",
			"running in the background is stopped then. Do not end a turn to wait for\n",
			"one: wait for it, and write the last message once it has finished.\n\n",
